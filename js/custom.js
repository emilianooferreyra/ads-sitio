...
$(document).ready(function () {
  ...
  $("#menu").mmenu({
    ...
    footer: {
      add: true,
      title: "Copyrights 2016 Diper. all rights reserved.",
    },
...
function validateContact() {
  ...
  var contact_service = document.getElementById("contact_service");
  ...
  } else if (checkcontact(contact_email.value) == false) {
    errors += "Por favor indica una dirección de email válida.";
  } else if (contact_phone.value == "") {
    errors += "Por favor indica tu teléfono.";
  } else if (contact_service.value == "0") {
    errors += "Por favor indica un servicio.";
  } else if (contact_message.value == "") {
    errors += "Por favor indica en qué podemos ayudarte.";
  }
  ...
  if (errors) {
    ...
    data.append("Nombre", contact_name.value);
    data.append("Email", contact_email.value);
    data.append("Teléfono", contact_phone.value);
    data.append("Servicio", contact_service.value);
    data.append("Mensaje", contact_message.value);

    var xhr = new XMLHttpRequest();
    xhr.open("POST", "https://formspree.io/myynpnpe");
    ...
    $.ajax({
      ...
      success: function (msg) {
        if (msg == "success") {
          ...
          document.getElementById("success").style.display = "block";
          document.getElementById("success").innerHTML =
            "Gracias! Pronto entraremoms en contacto.";
        } else {
          document.getElementById("error").style.display = "block";
          document.getElementById("error").innerHTML =
...
$(function () {
  ...
  $("#contenedor-del-popover").click(function () {
